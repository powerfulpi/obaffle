...
import { analyzePcm16, pcmMonoToStereo, pcmStereoToWav, speechText, } from "../src/audio.js";
...
describe("speechText", () => {
    it("removes common markdown before TTS", () => {
        assert.equal(speechText("**Hello** [friend](https://example.com) `now`"), "Hello friend now");
    });
});
